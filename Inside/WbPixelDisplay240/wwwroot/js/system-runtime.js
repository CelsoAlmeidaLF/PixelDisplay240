...
(function () {
    ...
    window.PixelDisplay240System = {
        ...
        manifest: [
            ...
            { id: 'window-manager', file: 'window-manager.js', description: 'Gerenciador de Janelas' },
            { id: 'hardware', file: 'hardware.js', description: 'Gestão de Hardware' },
            ...
            { id: 'main', file: 'script_restored.js', description: 'Orquestrador Principal' }
        ],
